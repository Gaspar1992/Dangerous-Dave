...
LDLIBSOPTIONS=-l sfml-graphics -l sfml-window -l sfml-system -l sfml-audio -l tinyxml
...
${OBJECTDIR}/SettingsParser.o: SettingsParser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SettingsParser.o SettingsParser.cpp
...
${OBJECTDIR}/footer.o: footer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/footer.o footer.cpp
